...
@section('content')
    <div class="mx-auto w-fit">
        ...
        <form action="post" class="flex flex-col">
            <input class="w-[300px] py-3 px-4 border border-gray-300" type="text" placeholder="Email address">
            <input class="w-[300px] py-3 px-4 border border-gray-300" type="text" placeholder="Password">
